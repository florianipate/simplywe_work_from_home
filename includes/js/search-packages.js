...
function packageDisplay(packages) {
    ...
    for (i = 0; i < allPackages.length; i++) {
        ...
        var venuePackageSubtitle = allPackages[i]["venue_package_subtitle"];
