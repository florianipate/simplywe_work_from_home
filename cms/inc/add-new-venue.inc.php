        ...
        if(Input::exists()){
            ...
            $validation = $validate->check($_POST, array(
                ...
                'venue_max_daytime' => array(
                    'name' => 'Venue Max Daytime Capacity',
                    'required' => true,
                    'max' =>4
                    
                ),
                'venue_max_evening' => array(
                    'name' => 'Venue Max Evening Capacity',
                    'required' => true,
                    'max' =>4
            ...
            if($validation->passed()){
                ...
                Session::put('venue_max_daytime', escape(Input::get('venue_max_daytime')));
                Session::put('venue_max_evening', escape(Input::get('venue_max_evening')));
